...
namespace TriangleNet
{
    ...
    public class Mesh
    {
        ...
        /// <summary>
        /// Justin Murray addition: gets the vertex by index, so the mesh can be used with edges.
        /// TODO: Remove when/if I figure out there was another way I was supposed to do this.
        /// </summary>
